...
class LocationDetectionNotifier extends _$LocationDetectionNotifier {
  ...
  Future<void> detectLocationFromFile(
    ...
    try {
      ...
      final response = await openAIService.analyzeImageLocation(
        imageFile: imageFile,
      );
      
      // Extract location information
      final locationInfo = openAIService.extractLocationInfo(response);
      ...
      final result = DetectionResult(
        id: id,
        locationName: locationInfo['locationName'] as String,
        latitude: locationInfo['latitude'] as double?,
        longitude: locationInfo['longitude'] as double?,
        imageUrl: imageUrl,
        originalPrompt: locationInfo['rawContent'] as String?,
        deviceId: deviceId,
